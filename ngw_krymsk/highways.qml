...
<qgis version="2.14.3-Essen" minimumScale="-4.65661e-10" maximumScale="2e+06" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="1" type="RuleRenderer" enableorderby="0">
    <rules key="{0c1a7357-5858-46a0-9caa-5af24043c56f}">
      ...
      <rule scalemaxdenom="50000" filter="HIGHWAY = 'track'" key="{d91b7655-ad03-4f08-8595-8695f824c3be}" symbol="15" label="сельскохозяйственного назначения"/>
      <rule scalemaxdenom="50000" filter="HIGHWAY = 'unclassified'" key="{bb93db77-8576-44f7-a7f6-e40ec9f6a85b}" symbol="16" label="местного значения"/>
      <rule scalemaxdenom="50000" filter="HIGHWAY = 'bridleway'" key="{dbed3842-d68d-46b3-a9fe-0a939bc937f0}" symbol="17" label="для верховой езды"/>
      <rule scalemaxdenom="50000" filter="HIGHWAY = 'ford'" key="{dcddeec7-1a99-462f-837e-6a9b6192a1be}" symbol="18" label="броды"/>
      <rule scalemaxdenom="50000" filter="HIGHWAY = 'raceway'" key="{c20a9b53-13f7-49ab-a769-87193e56a3a9}" symbol="19" label="гоночные трассы"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        ...
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="round"/>
          <prop k="line_color" v="173,219,173,255"/>
          <prop k="line_style" v="solid"/>
